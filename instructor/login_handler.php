...
// Query ONLY the instructors table
$stmt = $conn->prepare("SELECT id, email, password, first_name, middle_name, last_name FROM instructors WHERE email = ? LIMIT 1");
...
recordLogin($conn, $user['id'], $_SESSION['name'], 'instructor');
